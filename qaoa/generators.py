...
def qaoa_func_generator_no_optimisation(dev, H_ising, mixer_layer, generator_params: BasicParams):
    ...
    @qml.qnode(dev)
    def adjoint_disabled_cost_function(params):
        gammas = params[0]
        betas = params[1]
    ...
    return adjoint_disabled_cost_function, sample_function

def qaoa_func_generator_no_jax(dev, H_ising, mixer_layer, generator_params: BasicParams):
    num_qubits = generator_params.num_qubits
    wire_offsets = generator_params.wire_offsets
    seq_positions = generator_params.seq_positions
    rotamer_counts = generator_params.rotamer_counts
    ...
    def adjoint_enabled_cost_function(params):
        gammas = params[0]
        betas = params[1]
    ...
    return adjoint_enabled_cost_function, sample_function

def qaoa_func_generator_normal(dev, H_ising, mixer_layer, generator_params: BasicParams):
    num_qubits = generator_params.num_qubits
    wire_offsets = generator_params.wire_offsets
    seq_positions = generator_params.seq_positions
    rotamer_counts = generator_params.rotamer_counts
